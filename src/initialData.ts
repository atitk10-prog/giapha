...
export const initialBranches: ClanBranch[] = [
  {
    ...
    description: 'Chi họ ngành trưởng cư trú chính tại dòng tộc hương hỏa Quảng Nam.'
  },
  {
    id: 'CHI_THU_01',
    ...
    description: 'Chi họ ngành thứ cư trú chính tại Đà Nẵng và các tỉnh phía Nam.'
  }
];
...
export const initialMembers: ClanMember[] = [
  // ĐỜI 1
  {
    ...
    isDeceased: true,
    dod: '1970',
    burialPlace: 'Bản tộc Lăng mộ, Duy Xuyên, Quảng Nam',
    ...
    biography: 'Đồng chí khởi đầu gầy dựng gia nghiệp tộc Nguyễn Văn tại xã Duy Xuyên, là người nhân hậu, tiếng thơm xa gần.',
    achievements: ['Khai sơn lập tộc Nguyễn Văn', 'Được sắc phong Tộc Trưởng hiếu nhân'],
  ...
  },
  {
    ...
    isDeceased: true,
    dod: '1975',
    burialPlace: 'Duy Xuyên, Quảng Nam',
    birthPlace: 'Điện Bàn, Quảng Nam',
    hometown: 'Điện Bàn, Quảng Nam',
  ...
  // ĐỜI 2
  {
    ...
    isDeceased: true,
    dod: '1995',
    burialPlace: 'Nghĩa trang Duy Xuyên, Quảng Nam',
    birthPlace: 'Duy Xuyên, Quảng Nam',
    hometown: 'Duy Xuyên, Quảng Nam',
  ...
  // ĐỜI 3
  {
    ...
    isDeceased: true,
    dod: '2020',
    burialPlace: 'Hương hỏa tộc viên Duy Xuyên, Quảng Nam',
  ...
  },
  {
    ...
    biography: 'Đang đảm đương ngôi ví Trưởng chi họ Trưởng Nguyễn Văn tại Quảng Nam. Lưu giữ hương hỏa, tộc phả dòng tộc.',
...
export const initialEvents: ClanEvent[] = [
  {
    id: 'EV_001',
    title: 'Đại Lễ Giỗ tổ Tộc Nguyễn Văn',
    ...
    location: 'Nhà thờ họ Nguyễn Văn Duy Xuyên, Quảng Nam',
    host: 'Trưởng tộc Nguyễn Văn Hùng',
  ...
  },
  {
    ...
    location: 'Sân trung tâm Từ đường họ, Duy Xuyên, Quảng Nam',
...
export const initialScholarships: ScholarshipRecord[] = [
  {
    ...
    awardName: 'Học bổng Nguyễn Văn Đột Phá Công Nghệ',
    year: 2025,
    amount: 5000000
  },
  {
